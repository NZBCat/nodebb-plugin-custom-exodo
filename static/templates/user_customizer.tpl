...
<div class="form-group">
	<div class='row'>
		...
		<div class='col-lg-4'>
			<label for="brand-color-input">Color de fondo (editor y emergentes)</label>
...
<div class="form-group">
	<div class="row">
		<div class='col-lg-3'>
			<label for="brand-color-input">Color del borde</label>
		...
		<div class='col-lg-3'>
			<label for="brand-color-input">Color resaltado</label>
